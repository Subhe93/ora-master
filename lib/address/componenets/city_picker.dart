              ...
              child: DropdownButtonHideUnderline(
                child: ButtonTheme(
                  ...
                  child: DropdownButton<String>(
                    ...
                    items:Provider.of<CitiesProvider>(context,listen: false).cities.map((String map) {
                      return new DropdownMenuItem<String>(
                        value: map.toString(),
                        //+value: _selected,
                        child: Container(
                            margin: EdgeInsets.only(left: 10),
                            child: Container(width:MediaQuery.of(context).size.width/2,child: Text(map,overflow:TextOverflow.ellipsis,))),
                      );
                    }).toList(),
                  ),
                ),
